...
int limit = response.extract().path("limit");
    ...
    @Test
    public void test003() {
       String firstProduct = response.extract().path("data[0].name");
        System.out.println("------------------StartingTest---------------------------");
        System.out.println("The first product name is : " + firstProduct);
        System.out.println("------------------End of Test---------------------------");
    }
    ...
    @Test
    public void test004() {
      //homework hashmap  List<String> listOfCategories = response.extract().path()
    ...
    public void test006() {
        //homeowkr data.name
        List<Integer> listOfName = response.extract().path("data.name");
        System.out.println("------------------StartingTest---------------------------");
        System.out.println("The names of the products are : " + listOfName);
        System.out.println("------------------End of Test---------------------------");
    }
...
List<HashMap<String, ?>> values = response.extract().path("data.findAll{it.name == 'Duracell - AA Batteries (8-Pack)'}");
    ...
    @Test
    public void test008() {
    List<Double> price = response.extract().path("data.findAll{it.name == 'Duracell - AA Batteries (8-Pack)'}.price");
        System.out.println("------------------StartingTest---------------------------");
    ...
    @Test
    public void test009() {
        List<String> listOfNamePrice = response.extract().path("data.findAll{it.price > 16.99}.name");
        System.out.println("------------------StartingTest---------------------------");
        System.out.println("The names of products that price is less than 16.99 are: " + listOfNamePrice);
        System.out.println("------------------End of Test---------------------------");
    }
    ...
    @Test
    public void test011() {
        List<?> productEndWith = response.extract().path("data.findAll{it.name.endsWith('Black')}.price");
        System.out.println("------------------StartingTest---------------------------");
        System.out.println("The prices of products whose name end with = Vehicles are: " + productEndWith);
        System.out.println("------------------End of Test---------------------------");
    }
